...
firstVideoProject.innerHTML = `
    <video src=${allMedia.project_videos.first_vp} width="700" type="video/mp4" preload="auto"></video>
    <p class="copyright-video">Asparagus - Suzan Pitt <i>1979</i></p>
`

secondVideoProject.innerHTML = `
    <video src=${allMedia.project_videos.second_vp} width="700" type="video/mp4" preload="auto"></video>
    <p class="copyright-video">Salomé - Téo Hernandez <i>1976</i></p>
`
thirdVideoProject.innerHTML = `
    <video src=${allMedia.project_videos.third_vp} width="700" type="video/mp4" preload="auto"></video>
    <p class="copyright-video">Brouillard Passage 14 - Alexandre Larose <i>2014</i></p>
`
fourthVideoProject.innerHTML = `
    <video src=${allMedia.project_videos.fourth_vp} width="700" type="video/mp4" preload="auto"></video>
...
firstVideo.innerHTML = `
    <video src=${allMedia.ceci_videos.first_v} type="video/mp4" preload="auto"></video>
...
fourthVideo.innerHTML = `
    <video src=${allMedia.ceci_videos.fourth_v} type="video/mp4" preload="auto"></video>
    <p class="copyright-video">Kika opowiesci o czlowieku - Bogdan Dziworski <i>1983</i></p>
`
fifthVideo.innerHTML = `
    <video src=${allMedia.ceci_videos.fifth_v} type="video/mp4" preload="auto"></video>
    <p class="copyright-video">Ofrenda - Claudio Caldini <i>1978</i></p>
`
sixVideo.innerHTML = `
    <video src=${allMedia.ceci_videos.six_v} type="video/mp4" preload="auto"></video>
